...
//        policyDetails.setTrailerDetails(policyDetails.getTrailerDetails());
        ...
        policyDetails.setCover(new Cover(true
                ...
                true,
                new ArrayList<>(list),
                new ArrayList<>(paCoverToOwnerList),
                new ArrayList<>(paToNamedPassengerList),
                new ArrayList<>(paToUnNamedPassengerList),
                new ArrayList<>(paToPaidDriverList),
                new ArrayList<>(paToPaidCleanerList),
                new ArrayList<>(liabilityToPaidDriverList),
                new ArrayList<>(liabilityToEmployeeList),
                new ArrayList<>(nfppIncludingEmployeesList),
                new ArrayList<>(workmenCompensationExcludingDriverList),
                new ArrayList<>(paToConductorList),
                new ArrayList<>(liabilityToConductorList),
                new ArrayList<>(liabilitytoCoolieList),
                new ArrayList<>(legalLiabilitytoCleanerList)));
